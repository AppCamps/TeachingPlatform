      ...
      <div className={style.registration}>
        ...
        <div className={style.registrationSuccess}>
          ...
          <div className={style.confirmationInfo}>
            ...
            <p>
              {t('You will soon receive an confirmation email. To complete your registration, please click on the confirmation link in the email. Afterwards you will be able to sign in.')}
            </p>
            <p>
              {t('If the email does not arrive within the next minutes please {resendConfirmationLink} it or {supportEmailLink}.',
                {
                  supportEmailLink: <a href={supportEmailUrl}>{t('send us an email')}</a>,
                  resendConfirmationLink: <a href={resendConfirmationUrl}>{t('click here to resend')}</a>,
                },
              )}
            </p>
          </div>
