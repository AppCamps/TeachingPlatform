    ...
    if (selectedRole === "student") {
      return (
        ...
        >
          ...
          <p>
            {t("Please read our blog post", {
              bloglink: (
                <a
                  href="https://appcamps.de/2018/01/19/informatik-ag-in-der-schule-von-schuelern-fuer-schueler/"
                  target="_blank"
                >
                  {t("To blog post")}
                </a>
      ...
      <div className={style.container}>
        <div className={style.registration}>
          <h1 className={style.heading}>
            {t("Please sign up for free access")}
          </h1>
...
const validate = (values) => {
  const errors = {};
  const { email, password, passwordConfirmation, privacyPolicyAccepted } =
    values;
  ...
  if (!privacyPolicyAccepted) {
    errors.privacyPolicyAccepted = translatedFormError(
