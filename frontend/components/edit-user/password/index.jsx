...
class EditUserPassword extends Component {
  @autobind
  onSubmit(formValues) {
    const { updateUser, user: { id }, reset } = this.props;
      ...
      <form onSubmit={handleSubmit(this.onSubmit)}>
        <div>
          <div className={style.password}>
            <Field
              name="currentPassword" type="password" label={t('Current password')}
              component={InputWithLabel} required
            />
          </div>
          <div className={style.password}>
            <Field
              name="password" type="password" label={t('New password')}
              component={InputWithLabel} required
            />
          </div>
          <div className={style.password}>
            <Field
              name="passwordConfirmation" type="password" label={t('Confirm new password')}
              component={InputWithLabel} required
            />
          </div>
        </div>
