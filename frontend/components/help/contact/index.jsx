  ...
  <div className={style.container}>
    ...
    <div className={style.contentContainer}>
      <p className={style.question}>
        Du hast folgende Möglichkeiten mit dem App Camps Team Kontakt aufzunehmen:
      </p>
      <ol className={style.list}>
        <li>
          Du nutzt unseren Chat{' '}
          <a className="custom-intercom-launcher" tabIndex="0" role="link">
            <img style={{ width: '32px', height: '32px' }} src={image} alt="Intercom" />
          </a>{' '}
          unten rechts. Dort landet deine Nachricht direkt beim Team und wir können dir schnell
          antworten.
        </li>
        <li>
