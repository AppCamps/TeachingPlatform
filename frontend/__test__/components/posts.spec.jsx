...
describe("<Posts />", () => {
  ...
  it("renders the posts", () => {
    ...
    posts.forEach((post, index) => {
      ...
      const releaseDate = `${post.releasedAt.getDate()}.${
        post.releasedAt.getMonth() + 1
      }.${post.releasedAt.getFullYear()}`;
      ...
      expect(postElement.find("img").prop("src")).toEqual(
        posts[index].teaserImageUrl
      );
      expect(postElement.find(".releaseDate").text()).toEqual(
