...
describe("<AddClassInformations />", () => {
  ...
  it("updates schoolSubjectLabel based on plannedSchoolUsage values", () => {
    ...
    const schoolSubjectLabel = () =>
      wrapper.find(`.${style.schoolSubject} label`);
    expect(schoolSubjectLabel()).to.have.text(
      "In which school subject will you use the materials?"
    );

    wrapper = setupWrapper({
      formValues: { ...formValues, plannedSchoolUsage: "project_group" },
    });
    expect(schoolSubjectLabel()).to.have.text(
    ...
    wrapper = setupWrapper({
      formValues: { ...formValues, plannedSchoolUsage: "lesson_choice" },
    });
    expect(schoolSubjectLabel()).to.have.text(
      "In which school subject will you use the materials?"
    );
    ...
    wrapper = setupWrapper({
      formValues: { ...formValues, plannedSchoolUsage: "project_days" },
    });
    expect(schoolSubjectLabel()).to.have.text(
    ...
    wrapper = setupWrapper({
      formValues: { ...formValues, plannedSchoolUsage: "lesson_duty" },
    });
    expect(schoolSubjectLabel()).to.have.text(
      "In which school subject will you use the materials?"
    );
