...
describe('<TeachingMaterial/>', () => {
  ...
  it('should contain TeachingMaterial Title', () => {
    const wrapper = mount(<TeachingMaterial teachingMaterial={teachingMaterial} number={0} />);

    expect(wrapper.find('.title')).to.have.text(teachingMaterial.title);
  });

  it('should contain Number', () => {
    const wrapper = mount(<TeachingMaterial teachingMaterial={teachingMaterial} number={3} />);
  ...
  it('should contain Link to TeachingMaterial if teachingMaterial.isVideo()', () => {
    ...
    expect(wrapper.find('a').props().target).to.equal(TeachingMaterial.TARGET_ID);
  });
  ...
  it('should have props given props', () => {
    const wrapper = mount(<TeachingMaterial teachingMaterial={teachingMaterial} number={5} />);
