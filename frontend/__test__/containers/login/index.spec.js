...
import { mapStateToProps, mapDispatchToProps, __RewireAPI__ as containerRewire } from '../../../containers/login';
...
describe('Login Container', () => {
  ...
  describe('mapDispatchToProps', () => {
    ...
    it('acceptPrivacyPolicy', () => {
      ...
      containerRewire.__Rewire__('acceptPrivacyPolicy', acceptPrivacyPolicyMock);
    ...
    it('setAuthenticationRedirect', () => {
      ...
      containerRewire.__Rewire__('setAuthenticationRedirect', setAuthenticationRedirectMock);
      ...
      expect(setAuthenticationRedirectMock.mock.calls[0]).to.deep.equal(['/bruessel']);
    });
  });
});
