...
describe('Courses/Redirect Container + Component', () => {
  describe('mapStateToProps', () => {
    ...
    it('returns slug of topic, course and lesson', () => {
      ...
      const { topicSlug, courseSlug, lessonSlug } = mapStateToProps(store.state, {
  ...
  describe('mapDispatchToProps', () => {
    ...
    it('redirect', () => {
      ...
      expect(result).toEqual(replace(`/topics/${topicSlug}/${courseSlug}/${lessonSlug}`));
    });
  });
  ...
  describe('Component', () => {
    ...
    it('redirects to new url if topicSlug is present', () => {
      ...
      expect(redirect.mock.calls[0]).toEqual(['topicSlug', 'courseSlug', 'lessonSlug']);
    });
  });
});
