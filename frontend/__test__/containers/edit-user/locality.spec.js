...
import { mapStateToProps, mapDispatchToProps, __RewireAPI__ as containerRewire } from '../../../containers/edit-user/locality';
...
describe('Edit User Locality Container', () => {
  describe('mapStateToProps', () => {
    ...
    it('calls includes localityMapStateToProps in props', () => {
      ...
      const localityMapStateToPropsMock = jest.fn(() => localityMapStateToPropsResult);
      containerRewire.__Rewire__('localityMapStateToProps', localityMapStateToPropsMock);
    ...
    describe('initialValues', () => {
      it('returns initialValues', () => {
        ...
        expect(initialValues).to.deep.eql(pick(
          locality,
          [
            'schoolType',
            'schoolTypeCustom',
