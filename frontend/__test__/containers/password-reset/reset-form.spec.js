...
import { mapStateToProps, mapDispatchToProps, __RewireAPI__ as containerRewire } from '../../../containers/password-reset/reset-form';
...
describe('Password Reset Container', () => {
  ...
  describe('mapDispatchToProps', () => {
    it('passwordReset', () => {
      ...
      expect(passwordResetMock.mock.calls[0]).to.eql([formData, passwordResetToken]);
    });
  });
});
