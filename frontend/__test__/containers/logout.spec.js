...
describe('Logout container', () => {
  describe('#mapDispatchToProps', () => {
    describe('#logoutUser', () => {
      afterEach(() => { __RewireAPI__.__ResetDependency__(); });
      ...
      it('redirects on success', (done) => {
        ...
        __RewireAPI__.__Rewire__('logoutUser', () => Promise.resolve('logoutUser'));
      ...
      it('redirects on failure', (done) => {
        const dispatch = jest.fn(thunkMock);
        __RewireAPI__.__Rewire__('logoutUser', () => Promise.reject('logoutUser'));
