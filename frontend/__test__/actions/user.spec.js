...
import { updateUser, __RewireAPI__ as RewireAPI } from "../../actions/user";
...
describe("User actions", () => {
  describe("updateUser", () => {
    it("should send update request to api and dispatch apiFetched and push('/registration/success')", () => {
      const updateUserApiRequestMock = jest.fn(() =>
        Promise.resolve(normalizedSuccessResponse)
      );
      RewireAPI.__Rewire__("updateUserApiRequest", updateUserApiRequestMock);
