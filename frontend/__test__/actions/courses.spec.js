...
import { fetchCourses, __RewireAPI__ as RewireAPI } from '../../actions/courses';
...
describe('actions/courses', () => {
  describe('fetchCourses', () => {
    it('should fetch courses from api and dispatch coursesFetched', () => {
      RewireAPI.__Rewire__('getCourses', () => Promise.resolve(normalizedSuccessResponse));
      ...
      const store = mockStore({ api: { courses: {}, topics: {}, lessons: {} } });
