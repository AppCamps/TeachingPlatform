...
export const postsSelector = createSelector(
  ...
  createOrmSelector((session, page, pagination) => {
    const posts = session.Post.orderBy(['pinned', 'releasedAt'], ['desc', 'desc']).toRefArray();
...
export const unreadPostsPresentSelector = state => userSelector(state).unreadPostsPresent;
